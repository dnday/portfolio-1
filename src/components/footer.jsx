...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "Github", url: "https://github.com/dnday", icon: <BsGithub size={24} className="text-white" /> },
    { name: "Twitter", url: "https://twitter.com/marcel9994", icon: <BsTwitter size={24} className="text-white" /> },
    { name: "LinkedIn", url: "https://linkedin.com/in/marcelinus-dinoglide-yoga-prakoso", icon: <BsLinkedin size={24} className="text-white" /> },
  ];
